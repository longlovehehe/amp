...
<form id="form" class="base mrbt10" action="?modules=enterprise&action=save_shell">
   ...
   <div class="block">
        ...
        <input  maxlength="64" autocomplete="off" ep_name="true"  maxlength="32" name="e_name" type="text" required="true" />

    </div>
    <div class="block">
        <label class="title">{"企业注册号"|L}：</label>
        <input maxlength="64" autocomplete="off" maxlength="32" name="e_regis_code" type="text" />
    </div>
    <div class="block">

        <label class="title">{"企业地址"|L}：</label>

        <input  maxlength="64" autocomplete="off" {*addr="true"*}  maxlength="32" name="e_addr" type="text" required="true" />
    ...
    <div class="block">
        ...
        <input  maxlength="64" autocomplete="off"  maxlength="32" name="e_industry" type="text" />
    ...
    <div class="block">
        ...
        <input  maxlength="32" autocomplete="off" placeholder="{'名字'|L}" maxlength="32" value='' chinese="true" name="e_contact_name" type="text"  required="true" />
    ...
    <div class="block">
        ...
        <input  maxlength="32" autocomplete="off" placeholder="{'姓氏'|L}" maxlength="32" value='' chinese="true" name="e_contact_surname" type="text"  required="true" />
    ...
    <div class="block">
        ...
        <input fox="true"  maxlength="64" autocomplete="off"  maxlength="32" name="e_contact_fox" type="text" />
    ...
    <div class="block">
        ...
        <input  maxlength="32" autocomplete="off"  maxlength="32" value='' email="true" name="e_contact_mail" type="text" required="true"  />
    ...
    <div class="block">
        ...
        <select value="" id="e_mds_id" name="e_mds_id" size="10"  class=" long" action="?m=device&action=mds_option" data='[{ "to": "e_vcr_id","field": "d_deployment_id","view":"false" }]' selected="true"></select>
...
<h2 class="title">{"企业管理员配置"|L}</h2>   
     ...
     <div class="block">
       ...
       <input  maxlength="32" autocomplete="off" placeholder="{'名字'|L}" maxlength="32" value='' chinese="true" name="em_admin_name" type="text"  required="true" />
     ...
     <div class="block">
       ...
       <input  maxlength="32" autocomplete="off"  placeholder="{'姓氏'|L}" maxlength="32" value='' chinese="true" name="em_surname" type="text"  required="true" />

    </div>

    <div class="block">
        <label class="title">{"管理员密码"|L}：</label>
        <input  maxlength="32" autocomplete="off"  maxlength="32" id="password" value='' paswd="true" name="em_pswd" type="password" required="true"  />
    </div>
    <div class="block">

        <label class="title">{"手机号"|L}：</label>

        <input class="mobile-number" mobile1="true" maxlength="32" type="text" style="height: 28px;width: 245px;border:1px solid #ccc;" name="em_phone" value="{$item.em_phone}" required="true"/>
    ...
    <div class="block">
        ...
        <input  maxlength="32" autocomplete="off"  maxlength="32" value='' email="true" name="em_mail" type="text" required="true"  />
